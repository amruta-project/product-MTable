		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product MTable",
									"targetURL": "#productmtable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productmtable-display": {
								"semanticObject": "productmtable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productmtable",
									"url": sap.ui.require.toUrl("productmtable")
								}
							}
						}
					}
